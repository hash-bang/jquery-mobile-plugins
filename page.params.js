...
$(document).bind('pagebeforechange', function(e, data) {
	...
	console.log('Router - Trigger pareprepare on #' + hash);
	$('#' + hash).trigger('pageprepare', [data]);
});

$.routerTrigger = function(e) {
	if (!$.mobile) {
		console.log('Router called before jQMobile load');
		return;
	}
...
$(window).on('hashchange', $.routerTrigger);
$.routerTrigger();
